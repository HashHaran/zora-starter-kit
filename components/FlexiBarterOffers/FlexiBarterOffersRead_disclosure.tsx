...
import { GetExistingFlexiBarterOffers } from './GetExisitingFlexiBarterOffers'
...
export default function FlexiBarterOffersRead_disclosure(nft) {
                        ...
                        /> */}
                            ...
                            <Disclosure.Panel className="bg-slate-900 border-white border-2 border-solid flex flex-row flex-wrap items-center p-2 text-lg w-full">
                                <div className="w-fit flex flex-row flex-wrap">
                                    <GetExistingFlexiBarterOffers nft={nft} />
                                </div>
                            </Disclosure.Panel>
                        </>
                    )}
